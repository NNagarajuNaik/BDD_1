...
public class Sample {
	...
	public static void main(String[] args) throws Throwable {
		...
		WebElement book = driver
				.findElement(By.xpath("(//button[contains(@class,'ml-6 room_rate_btn')])[1]"));
		...
		public void i_open_browser_with_url_as(String arg1) throws Throwable {
			WebDriverManager.chromedriver().setup();
			driver = new ChromeDriver();
			driver.manage().window().maximize();
			wait = new WebDriverWait(driver, 10);
		...
		public void i_validate_modify_search() throws Throwable {
			...
			for (WebElement MSearch : modify) {
				System.out.println(MSearch.getText());
			}

		}

		@Then("^I validate number of filters$")
		public void i_validate_number_of_filters() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		@Then("^I validate number of options for priority$")
		...
		@Then("^I verify filter by hotels$")
		public void i_verify_filter_by_hotels() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		public void i_verify_total_price() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			wait.until(
		...
		@Then("^I verify Hotel class$")
		public void i_verify_Hotel_class() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			wait.until(
		...
		@Then("^I verify Special offers$")
		public void i_verify_Special_offers() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		@Then("^I verify TripAdviser rating$")
		public void i_verify_TripAdviser_rating() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(
		...
		@Then("^I verify Amenties$")
		public void i_verify_Amenties() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(
		...
		@Then("^I verify Property type$")
		public void i_verify_Property_type() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(
		...
		@Then("^I validate populer hotels$")
		public void i_validate_populer_hotels() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		@Then("^I validate populer hotel chains$")
		public void i_validate_populer_hotel_chains() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		@Then("^I validate other tools$")
		public void i_validate_other_tools() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
		...
		@When("^I click view detials$")
		public void i_click_view_detials() throws Throwable {
			System.out.println();
			wait = new WebDriverWait(driver, 10);
			WebElement view = driver.findElement(By.xpath("(//button[text()='View details'])[1]"));
			JavascriptExecutor js = (JavascriptExecutor) driver;
